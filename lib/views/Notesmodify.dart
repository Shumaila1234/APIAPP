                ...
                onPressed: () async {
                 if(isEditing){
                   ...
                   final note=NoteManipulation(
                     ...
                     final title='Done';
                     final text=result.error?(errorMessage ?? "An error occured"): "Your note was updated.";
                 ...
                 else
                 {
                   ...
                   final note=NoteManipulation(
                     ...
                     final title='Done';
                     final text=result.error?(errorMessage ?? "An error occured"): "Your note was created";
