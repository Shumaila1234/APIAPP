...
import 'package:api_app/views/NoteDelete.dart';
              ...
              itemBuilder: (_, index) {
                return Dismissible(
                  ...
                  child: ListTile(
                    ...
                    subtitle: Text(
                        'Last edited on ${formatDateTime(_apiResponse.data[index].latestDatetime ?? _apiResponse.data[index].createDatetime)}'),
                    onTap: () {
